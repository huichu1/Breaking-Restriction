...
MODEL_NAME = "three" + str(name_ID)
FOLDER_NAME = "exp_three" + str(name_ID)
MODEL_ROOT_FOLDER_NAME = "three_layer_random_models/"
EXP_ROOT_FOLDER_NAME = "three_random_exp/"
RESULT_ROOT_FOLDER_NAME = "three_random_result"
