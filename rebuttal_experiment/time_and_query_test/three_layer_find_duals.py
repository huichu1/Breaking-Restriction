...
def main():
    ...
    np.random.seed(three_layer_utils.SEED)
    random.seed(three_layer_utils.SEED)
    ...
    print(f"Query consume: 2^{math.log2(three_layer_utils.query_num)} for seed {SEED} ",file=rebuttal_FILE)
    print("Finished")
