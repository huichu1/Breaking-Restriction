...
MODEL_NAME = "deep_eight1_42"
FOLDER_NAME = "exp_deep8_42"
...
# I know it's stupid, need to change it after
if TINY:
    IDIM = 30
...
WEIGHTS_DIM_LIST = [IDIM,DIM1,DIM2,DIM3,DIM4,DIM5,DIM6,DIM7,SHRINK,10]
...
class CIFAR10Net(nn.Module):
    def __init__(self):
        ...
        self.output_DIM = [DIM1,DIM2,DIM3,DIM4,DIM5,DIM6,DIM7,SHRINK,10]
        ...
        self.fc8 = nn.Linear(DIM7, SHRINK)
        self.fc9 = nn.Linear(SHRINK, 10)
        # self.relu = nn.ReLU()
        ...
        self.prelu8 = nn.PReLU(num_parameters=SHRINK)
